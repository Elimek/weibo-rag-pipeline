...
| 步骤 | 操作 | 说明 |
|------|------|------|
| 1 | 双击 **`一键安装.bat`** | 自动检测环境、装依赖、生成桌面快捷方式 |
| 2 | 打开 **`获取Cookie指南.html`** | 图文教程，2 分钟搞定 |
| 3 | 双击 **`启动网页版.bat`** | 浏览器自动打开，图形化搜索界面 |

> 💡 **完全不懂技术也能用** — 全程双击 `.bat` 文件，在浏览器里操作。
